...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const articles = ['greece', 'carthage', 'rome', 'black-hole', 'turkler', 'ekonomi', 'einstein-rosen', 'arcade', 'tibbi', 'internet', 'pirus', 'takyon', 'tardigrad', 'bagirsak', 'bakteriyofaj', 'endosimbiyoz', 'kaligrafi', 'doppler', 'dogal-secilim', 'dunya'];
