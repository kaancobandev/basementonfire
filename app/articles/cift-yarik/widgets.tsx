...
export const quizQs = [
  { text: "Tek tek gönderilen elektronlar ekranda ne oluşturur?", opts: [ 'Tek bir nokta', 'Hiçbir şey','İki basit yığın', 'Girişim şeritleri (aydınlık-karanlık bantlar)'], a: 3, exp: "Her elektron tek bir noktaya çarpar ama binlercesi birikince girişim deseni ortaya çıkar — her biri sanki kendisiyle girişim yapar." },
  ...
  { text: "de Broglie'nin λ = h/p formülü neyi açıklar?", opts: [ 'Neden atomlar kararlıdır', 'Elektronun kütlesini','Neden ışık hızlıdır', 'Neden büyük nesneler dalga gibi davranmaz (dalga boyları çok küçük)'], a: 3, exp: "Momentum büyüdükçe dalga boyu küçülür; futbol topunun dalga boyu ölçülemeyecek kadar minik kalır." },
  { text: "Girişim desenini yok eden asıl şey nedir?", opts: [ 'Yarıkların kapanması','İnsan bilinci', 'Bilginin çevreye yayılması (dekoherans)', 'Elektronun yavaşlaması'], a: 2, exp: "Elektron, yol bilgisini taşıyan aygıtla dolanır; bu dolanıklık bir kez oluşunca girişim geri gelmez." },
  { text: "60 karbon atomlu C60 molekülleriyle yapılan deneyde ne görüldü?", opts: [ 'Girişim deseni — koca moleküller de dalga gibi davrandı', 'Moleküller parçalandı', 'Sadece ısı','Hiç girişim yok'], a: 0, exp: "1999'da Zeilinger ekibi bunu gösterdi; sonra sınır 2000+ atoma taşındı." },
];
