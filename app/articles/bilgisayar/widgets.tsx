...
export const quizQs = [
  { text: "Bir transistör temelde ne yapar?", opts: [ 'Akımı geçirir (1) veya geçirmez (0) — minik bir anahtar', 'Isıyı depolar', 'Ses üretir','Işık üretir'], a: 0, exp: "Milyarlarca transistörü doğru birleştirince toplama, karşılaştırma gibi mantık işlemleri ortaya çıkar." },
  { text: "CPU ile GPU arasındaki temel fark nedir?", opts: [ 'İkisi aynıdır','GPU daha yavaştır', 'CPU az sayıda güçlü çekirdek, GPU binlerce basit çekirdek içerir', 'CPU görüntü çizemez'], a: 2, exp: "CPU karmaşık sıralı işler için; GPU aynı basit işi aynı anda binlerce veri üzerinde yapmak (paralel işleme) için idealdir." },
  { text: "RAM'in “uçucu (volatile)” olması ne demektir?", opts: [ 'Elektrik kesilince içindeki her şey silinir', 'Asla dolmaz', 'Sadece oyunlarda çalışır','Çok ısınır'], a: 0, exp: "Bu yüzden kaydetmeden bilgisayar kapanırsa belgeni kaybedersin — o veri RAM'deydi, kalıcı diske yazılmamıştı." },
  { text: "DDR (Double Data Rate) ismi nereden gelir?", opts: [ 'İki çekirdeği olduğu için', 'İki voltaj kullandığı için','İki kat pahalı olduğu için', 'Veriyi saatin hem yükselen hem alçalan kenarında taşıdığı için'], a: 3, exp: "Her saat tıkında bir yerine iki kez veri aktarır — bu yüzden “çift veri hızı”." },
