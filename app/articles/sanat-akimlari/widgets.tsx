...
export const quizQs = [
  { text: "Belgeye göre bir akım tipik olarak neyle doğar?", opts: [ 'Beş “motor”dan (para, teknoloji, siyaset, kurum reddi, paradigma) en az ikisinin kesişiminde', 'Sadece yeni bir boya icat edilince', 'Devlet emriyle','Tek bir dâhinin farklı resim yapma isteğiyle'], a: 0, exp: "Hiçbir akım tek motorla çıkmaz; genelde para, teknoloji, siyaset, kurum reddi ve paradigma kaymasından birkaçı üst üste biner." },
  { text: "Hollanda Altın Çağı neden “ekonomi belirler”in en net örneğidir?", opts: [ 'Yeni bir boya icat edildiği için', 'Kral resim sevdiği için','Devlet ressamlara maaş bağladığı için', 'Protestan ikonoklazm en büyük müşteriyi (kilise) silince açık piyasa ve tür uzmanlaşması doğduğu için'], a: 3, exp: "Kilise duvarı gidince sanatçı sipariş beklemeyip üretip sattı; manzara, natürmort, iç mekân gibi türler bu piyasadan doğdu." },
  ...
  { text: "Sanatın merkezinin Paris’ten New York’a geçmesinin asıl mekanizması neydi?", opts: [ 'Reklamın icadı','Amerikalıların daha yetenekli olması', 'Totaliter rejimlerden kaçan Avrupalı sanatçıların ABD’ye kitlesel göçü', 'Yeni bir müze açılması'], a: 2, exp: "Estetik bir zafer değil, bir göç dalgası: Mondrian, Ernst, Breton, Gropius, Mies, Albers… “Avrupa’nın kaybı, Amerika’nın kazancı.”" },
