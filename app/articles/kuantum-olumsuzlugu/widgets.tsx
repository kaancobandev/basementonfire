...
export const quizQs = [
  { text: "Süperpozisyon nedir?", opts: [ 'Ölçülene kadar birbirini dışlayan ihtimallerin bir arada bulunması', 'Parçacığın iki parçaya bölünmesi', 'Bir ölçüm hatası','Parçacığın çok hızlı olması'], a: 0, exp: "Havada dönen yazı-tura gibi: henüz ne yazı ne tura, ikisinin ihtimali aynı anda." },
  { text: "Kopenhag yorumunda ölçüm ne yapar?", opts: [ 'Parçacığı yok eder', 'Evreni ikiye ayırır','Hiçbir şey', 'Dalga fonksiyonunu çökertir; tek bir sonuç gerçek olur'], a: 3, exp: "Sayısız ihtimalden yalnızca biri gerçek olur; hangisi olacağını Born kuralı belirler." },
  { text: "Çok Dünyalı Yorum'a göre ölçümde ne olur?", opts: [ 'Her ihtimal ayrı bir dalda/evrende gerçekleşir; gözlemci de çatallanır', 'Sadece en olası sonuç gerçekleşir','Dalga çöker', 'Hiçbir ihtimal gerçekleşmez'], a: 0, exp: "Everett: hiçbir şey çökmez; evren her karar anında sessizce dallanır." },
  ...
  { text: "Fizikçilerin en temel itirazı nedir?", opts: [ 'Çok pahalı bir deney','Matematik yanlış', 'İddia dışarıdan yanlışlanamaz; kanıtlamak için ölmen gerekir', 'Kuantum mekaniği yanlış'], a: 2, exp: "Yalnızca birinci şahsa özel, test edilemez bir 'ya öyleyse?' sorusudur." },
  { text: "Adam Fawer'ın Mobius'u bu fikri neye çevirir?", opts: [ 'Bir korku filmine', 'Bir matematik problemine','Bir fizik ders kitabına', 'Bir pişmanlık makinesine — geçmişi değiştirme sorusuna'], a: 3, exp: "Fizik cevabı verir; roman bedeli gösterir: elimizde her şeyi geri alma şansı olsa daha iyisini yapar mıydık?" },
];
