...
//   /makale/onizleme/[id] → force-dynamic, sahip/admin önizlemesi (her statü)
// İçerik render'ı birebir aynı kalsın diye tek bileşende toplandı (2026-07-19,
// Paket F: ana rota ISR olurken önizleme ayrı rotaya taşındı).
...
export default function ArticleView({ a, isOwner = false }: { a: ArticleRow; isOwner?: boolean }) {
