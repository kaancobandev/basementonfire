  ...
  return (
    <main className="main-content">
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '20px 16px 14px', borderBottom: '1px solid var(--color-border)' }}>
        <div style={{ width: 52, height: 52, borderRadius: '50%', background: 'rgba(212,165,100,0.12)', color: '#d4a564', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          <div style={{ background: 'var(--color-surface)', borderRadius: 16, display: 'flex', maxWidth: 820, width: '100%', maxHeight: '90vh', overflow: 'hidden', position: 'relative' }}>
            ...
            <div style={{ flex: 1, background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 300, maxHeight: '90vh' }}>
              {selected.media_type === 'video' ? (
                <video key={selected.id} src={selected.media_url} controls autoPlay
