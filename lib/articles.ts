...
export const ARTICLES: ArticleMeta[] = [
  ...
  { slug: 'gobeklitepe', title: 'Göbeklitepe', emoji: '🗿', desc: "Ne kadar eski? ~MÖ 9600 — piramitlerden 7.000, yazıdan 6.000 yıl önce. Bu sayıyı okumak yerine kaydırarak kat et: aşağı indikçe geriye gidiyorsun, her durakta insanlığın ne yapabildiğini görüyorsun ve Göbeklitepe'ye varmadan mesafeyi hissediyorsun. Piramitler bize ondan daha yakın — kaydırmalı derin zaman ekseni", category: 'Tarih' },
];
