...
export const ARTICLES: ArticleMeta[] = [
  ...
  // Kimya rafının 2. makalesi. Eşik 3 → /discover/kimya HÂLÂ AÇILMIYOR.
  { slug: 'periyodik-tablo', title: 'Periyodik Tablo', emoji: '🧪', desc: "Tablo bir dolap değil, tahmin makinesi: Mendeleyev boş kareler bırakıp henüz bulunmamış elementleri tarif etti ve galyum, skandiyum, germanyum tarife uydu — ama aynı yöntem hiç bulunamayan on dört hayalet de üretti, isabet oranı %50'nin altında. Orbital blokları, Madelung kuralının yirmi istisnası ve IUPAC'in hâlâ karara bağlayamadığı 3. grup; 118 elementlik interaktif tabloyla", category: 'Kimya', topics: ['Atom', 'Bilim Tarihi'] },
  ...
  // Biyoloji rafinin 5. makalesi. ayna-noronlari ile karsilikli ic linkli.
  { slug: 'zihin-yukleme', title: 'Zihnini Yükleyebilir misin?', emoji: '🧠', desc: "Beyni haritalayabilir miyiz, haritayı çalıştırabilir miyiz, çalışan şey 'ben' olur mu? Tek soru sanılan şey aslında üç ayrı soru — ve yalnız ikisi ölçülebilir. Bir milimetreküp korteksin 1,4 petabaytından 302 nöronlu solucanın hâlâ çözülememesine, Matrix'in aslında yükleme filmi olmadığından 312 sinirbilimcinin medyan tahminine (insan için 2125). Ölçüldü / açık / ölçüye kapalı / kuruntu diye dört raf ve iddiaları kendin sınıflandırdığın interaktif ayraçla", category: 'Biyoloji', topics: ['Beyin', 'Sinir Sistemi', 'Bilgisayar', 'Felsefe'] },
  // Fizik rafinin 8. makalesi. cift-yarik ve kuantum-olumsuzlugu ile karsilikli linkli.
  { slug: 'kuantum-dolaniklik', title: 'Kuantum Dolanıklık', emoji: '🧦', desc: "İki parçacık ne kadar uzakta olursa olsun uyumlu çıkıyor — ama aralarında hiçbir şey gidip gelmiyor ve uyum, cevapların baştan yazılmış olmasıyla da açıklanamıyor. Bell'in çorap mecazından 2022 Nobel'ine, Leibniz'in iki saatinden Gazâlî'nin nedensellik itirazına, Üç Cisim'in sofonlarından 'kuantum' etiketli kolyelere. Her terim kullanılmadan önce açıklanıyor; Bell testini kendin oynadığın interaktif Mermin kutularıyla", category: 'Fizik', topics: ['Kuantum', 'Parçacıklar', 'Felsefe', 'Bilim Tarihi'] },
];
