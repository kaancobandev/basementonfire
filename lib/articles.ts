...
export const ARTICLES: ArticleMeta[] = [
  ...
  { slug: 'gobeklitepe', title: 'Göbeklitepe', emoji: '🗿', desc: "Bilinen en eski anıtsal tören yapısı: ~MÖ 9600'de, tarım-çömlek-yazı-metal-tekerlekten önce, avcı-toplayıcıların diktiği onlarca tonluk T-biçimli taş devler. Piramitlerden 7.000, yazıdan 6.000 yıl önce. Yüzsüz pilarlar, dört çember-dört hayvan, Akbaba Taşı, Schmidt'in 'önce tapınak' tezi ve Karahantepe — interaktif derin zaman kaydırıcısı, T-pilar kâşifi ve çevre haritasıyla", category: 'Tarih' },
];
